<script lang="ts">
  ...
  import { Menu, X, Home, Clock, User, MapPin, Settings, LogOut, MessageCircle } from 'lucide-svelte';
  ...
  const menuItems = [
    ...
    { href: '/driver/portal/rides', label: 'My Rides', icon: Clock },
    { href: '/driver/portal/profile', label: 'Profile', icon: User },
    { href: '/driver/portal/location', label: 'Location', icon: MapPin },
    { href: '/driver/portal/messages', label: 'Messages', icon: MessageCircle },
    { href: '/driver/portal/settings', label: 'Settings', icon: Settings }
  ];
